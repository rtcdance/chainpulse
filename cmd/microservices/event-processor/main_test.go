...
func TestLoadEventProcessorConfigDefaultsToSecurityDisabled(t *testing.T) {
	...
	t.Setenv("EVENT_PROCESSOR_AUTH_ENABLED", "")
	t.Setenv("EVENT_PROCESSOR_AUTH_JWT_SECRET", "")
	t.Setenv("EVENT_PROCESSOR_AUTH_API_KEYS", "")
	t.Setenv("EVENT_PROCESSOR_RATE_LIMIT_ENABLED", "")

	cfg := loadEventProcessorConfig()
	if cfg.AuthEnabled {
...
func TestLoadEventProcessorConfigParsesSecurityOverrides(t *testing.T) {
	t.Setenv("EVENT_PROCESSOR_AUTH_ENABLED", "true")
	t.Setenv("EVENT_PROCESSOR_AUTH_JWT_SECRET", "secret-123")
	t.Setenv("EVENT_PROCESSOR_AUTH_API_KEYS", "svc-key=client-1, svc-key-2:client-2")
	t.Setenv("EVENT_PROCESSOR_RATE_LIMIT_ENABLED", "true")
	t.Setenv("EVENT_PROCESSOR_RATE_LIMIT", "42")
...
func TestBuildEventProcessorSecurityControlsEnabled(t *testing.T) {

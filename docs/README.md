...
- **[Resilience Patterns](guides/RESILIENCE_PATTERNS_GUIDE.md)** - Fault tolerance
- **[Microservices Implementation](guides/MICROSERVICES_IMPLEMENTATION_GUIDE.md)** - Distributed deployment

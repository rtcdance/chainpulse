...
func (m *mockBenchStorage) WriteEvent(_ context.Context, _ *blockchain.BlockchainEvent) error {
	return nil
}

func (m *mockBenchStorage) WriteBatch(_ context.Context, _ []*blockchain.BlockchainEvent) error {
	return nil
}

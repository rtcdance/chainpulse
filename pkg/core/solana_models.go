...
const (
	...
	SPLTransferChecked   = "SPL:TransferChecked"
	SPLMintTo            = "SPL:MintTo"
	SPLBurn              = "SPL:Burn"
	SPLInitializeMint    = "SPL:InitializeMint"
	SPLInitializeAccount = "SPL:InitializeAccount"
	SPLCloseAccount      = "SPL:CloseAccount"
)
